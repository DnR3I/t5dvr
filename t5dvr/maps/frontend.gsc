...
mod_options_hint()
{
	...
	version_base = newClientHudElem(get_players()[0]);
	version_base.foreground = false;
	version_base.hidewheninmenu = false;
	version_base.alignX = "center";
	version_base.alignY = "top";
	version_base.horzAlign = "center";
	version_base.vertAlign = "top";
	version_base.x = 200;
	version_base.y = 30;
	version_base.alpha = 0;
	version_base FadeOverTime(1);
	version_base.alpha = 0.1;

	version = [];
	for(i = 0; i < 2; i++)
	{
		version[i] = newClientHudElem(get_players()[0]);
		version[i].foreground = true;
		version[i].hidewheninmenu = false;
		version[i].alignX = "center";
		version[i].alignY = "top";
		version[i].horzAlign = "center";
		version[i].vertAlign = "top";
		version[i].fontscale = 8;
		version[i].x = 0;
		version[i].alpha = 0;
		version[i] FadeOverTime(1);
		version[i].alpha = 1;
	}
	...
	version[0].x = 370;
	version[0].alpha = 0.1;
	version[0] SetText("t5dvr 1.0.1.0");
}
